...
$message = '';
 ...
 $sql = 'SELECT categories.name AS name, categories.category_id AS category_id, posts.category_id AS category_id, posts.category_name AS category_name FROM posts JOIN categories ON categories.category_id = posts.category_id;';
...
if( !isset( $_SESSION['user_login_status'] ) || empty( $_SESSION) )  {
...
<html>
    ...
    <body>
        ...
        <a href="./index.php?logout=TRUE">Logout</a> <!-- Need the =TRUE because the get method uses an array -->
